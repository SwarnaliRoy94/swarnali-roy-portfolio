...
export const profile = {
  ...
  headline:
    "Software Engineer with 4.5+ years experience of building React Native and React production apps, polished interfaces, and release-ready product workflows.",
  summary:
